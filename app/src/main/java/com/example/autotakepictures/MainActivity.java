...
//        mHandler.postDelayed(mToastRunnable, 1000);
    ...
    public void StopTakingPictures(View view) {
        ...
        Toast.makeText(MainActivity.this, "Stop taking pictures", Toast.LENGTH_SHORT).show();
    ...
    private Runnable mToastRunnable = new Runnable() {
        @Override
        public void run() {
            Toast.makeText(MainActivity.this, "Repeat taking pictures", Toast.LENGTH_SHORT).show();
            CaptureBurstIn mBurstCapture = new CaptureBurstIn(mCameraDevice, mCaptureSession, mImageReader);
